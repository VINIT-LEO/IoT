...
from Network.dijkstra import *
from Routing.q_learning import *
from Routing.leach import *
from Routing.beemh import *
from Routing.kMeans import *
from Routing.NMleach import *
from Routing.QL_EEBDG import *
from Models.svm_predict import *
from Models.dec_tree_predict import *
...
class network(object):
    def __init__(self,input):
        ...
        self.svm_predictor = SVM_predictor("Resourses/data.csv")
        self.dec_tree_predictor = Dec_Tree_predictor("Resourses/data.csv")
        self.alive_nodes()
